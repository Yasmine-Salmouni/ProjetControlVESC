/**
  ...
  ******************************************************************************
  */
#ifndef AI_MODEL_LSTM_KERAS_H
#define AI_MODEL_LSTM_KERAS_H

#include "model_lstm_keras_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MODEL_LSTM_KERAS_MODEL_NAME          "model_lstm_keras"
#define AI_MODEL_LSTM_KERAS_ORIGIN_MODEL_NAME   "model_lstm_keras"

/******************************************************************************/
#define AI_MODEL_LSTM_KERAS_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODEL_LSTM_KERAS_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODEL_LSTM_KERAS_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODEL_LSTM_KERAS_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODEL_LSTM_KERAS_IN \
  ai_model_lstm_keras_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_LSTM_KERAS_IN_SIZE { \
  AI_MODEL_LSTM_KERAS_IN_1_SIZE, \
}
#define AI_MODEL_LSTM_KERAS_IN_SIZE_BYTES { \
  AI_MODEL_LSTM_KERAS_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_LSTM_KERAS_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MODEL_LSTM_KERAS_IN_1_HEIGHT      (5)
#define AI_MODEL_LSTM_KERAS_IN_1_CHANNEL     (8)
#define AI_MODEL_LSTM_KERAS_IN_1_SIZE        (40)
#define AI_MODEL_LSTM_KERAS_IN_1_SIZE_BYTES  (160)

/******************************************************************************/
#define AI_MODEL_LSTM_KERAS_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODEL_LSTM_KERAS_OUT \
  ai_model_lstm_keras_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_LSTM_KERAS_OUT_SIZE { \
  AI_MODEL_LSTM_KERAS_OUT_1_SIZE, \
}
#define AI_MODEL_LSTM_KERAS_OUT_SIZE_BYTES { \
  AI_MODEL_LSTM_KERAS_OUT_1_SIZE_BYTES, \
}
#define AI_MODEL_LSTM_KERAS_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MODEL_LSTM_KERAS_OUT_1_CHANNEL     (1)
#define AI_MODEL_LSTM_KERAS_OUT_1_SIZE        (1)
#define AI_MODEL_LSTM_KERAS_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_MODEL_LSTM_KERAS_N_NODES (73)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup model_lstm_keras
 ...
 * @ref ai_model_lstm_keras_create. Both the activations memory buffer 
 ...
 * using @ref ai_model_lstm_keras_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_lstm_keras_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_lstm_keras_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_LSTM_KERAS_*
 * defines into file @ref model_lstm_keras.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_model_lstm_keras_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MODEL_LSTM_KERAS_H */
